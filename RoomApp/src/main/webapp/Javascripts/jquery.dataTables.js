...
(function($, window, document) {
	...
	_oExt.oJUIClasses = {
		...
		/* Sorting */
		"sSortAsc": "ui-state-focus",
		"sSortDesc": "ui-state-focus",
		"sSortable": "ui-state-focus",
		"sSortableAsc": "ui-state-focus",
		"sSortableDesc": "ui-state-focus",
		"sSortableNone": "ui-state-focus",
		"sSortColumn": "sorting_", /* Note that an int is postfixed for the sorting order */
...
//			this.aLengthMenu = [ 10, 25, 50, 100 ];
			 ...
			 */
			this._iDisplayLength = this.aLengthMenu[0];//10;
			this._iDisplayStart = 0;
			this._iDisplayEnd = this.aLengthMenu[0];//10;
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						/* Replace jQuery UI constants changed by Jai*/
						if ( sAttr == "H" )
						{
